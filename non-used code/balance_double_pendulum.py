...
def main():
    ...
    pendulum_body.center_of_gravity = (0, 0)
    pendulum_body.mass = 10

    pendulum_body.position = screenCenter + (0, -75)
    pendulum_shape = pymunk.Circle(pendulum_body, 10, (0, 0))
    pendulum_shape.friction = 1.0
    #pendulum_shape.damping = 0.1

    #pendulum 2
    pendulum_2_body = pymunk.Body(10, 10)
    pendulum_2_body.center_of_gravity = (0, 0)
    pendulum_2_body.mass = 10

    pendulum_2_body.position = screenCenter + (0, -150)
    pendulum_2_shape = pymunk.Circle(pendulum_2_body, 10, (0, 0))
    pendulum_2_shape.friction = 1.0
    #pendulum_shape.damping = 0.1

    play_body = pymunk.Body(10, 10)
    #float("inf")
    ...
    rotation_center_joint = pymunk.PinJoint(play_body, pendulum_body, (0, 0), (0, 0))
    rotation_center_joint.distance = 75
    rotation_center_joint_2 = pymunk.PinJoint(pendulum_body, pendulum_2_body, (0, 0), (0, 0))
    rotation_center_joint_2.distance = 75

    space.add(pendulum_body, pendulum_shape, pendulum_2_body, pendulum_2_shape, rotation_center_joint, rotation_center_joint_2, play_body, move_joint)
